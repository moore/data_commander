...
EMFLAGS =  -s EXPORTED_FUNCTIONS="[ '_readIndexStart', '_readValue', '_initIterator', '_nextValue', '_finishIterator', '_getName', '_getNameLength', '_getUnits', '_getUnitsLength', '_getColumCount', '_readColumnMin', '_readColumnMax', '_readEntriesCount']" --post-js $(POST_JS) -std=c++11 -I${MESSAGE_HEADDERS_DIR}
